<template>
  <view>
    ...
    <view>
      <text>这是微信小程序1的定制页面</text><text>这是微信小程序1的定制页面</text><text>这是微信小程序1的定制页面</text><text>这是微信小程序1的定制页面</text><text>这是微信小程序1的定制页面</text><text>这是微信小程序1的定制页面</text><text>这是微信小程序1的定制页面</text>
    </view>
  </view>
</template>
